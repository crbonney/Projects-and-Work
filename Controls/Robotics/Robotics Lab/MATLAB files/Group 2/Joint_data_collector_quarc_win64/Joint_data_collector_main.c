...
typedef RT_MODEL_Joint_data_collector RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Joint_data_collector(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Joint_data_collector_initialize();
   extern void Joint_data_collector_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Joint_data_collector_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Joint_data_collector -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Joint_data_collector_initialize();
  S = Joint_data_collector_M;
  ...
  Joint_data_collector_terminate();
