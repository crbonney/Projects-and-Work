...
#include "c2_data_dynamics_comparison.h"
...
static void initialize_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void initialize_params_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void enable_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void disable_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void ext_mode_exec_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void set_sim_state_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance, const mxArray
   *c2_st);
static void finalize_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void sf_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void c2_chartstep_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void initSimStructsc2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance, const mxArray *c2_xdot, const char_T *c2_identifier, real_T
  c2_y[4]);
static void c2_b_emlrt_marshallIn(SFc2_data_dynamics_comparisonInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_data_dynamics_comparisonInstanceStruct *
  chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[2]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[4]);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[33]);
static real_T c2_mpower(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance, real_T c2_a);
static void c2_eml_scalar_eg(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance);
static void c2_eml_warning(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance, const mxArray *c2_is_active_c2_data_dynamics_comparison, const
  char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_data_dynamics_comparisonInstanceStruct
  *chartInstance);
...
{
  int32_T *c2_sfEvent;
  uint8_T *c2_is_active_c2_data_dynamics_comparison;
  c2_is_active_c2_data_dynamics_comparison = (uint8_T *)ssGetDWork
    (chartInstance->S, 3);
  c2_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c2_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c2_is_active_c2_data_dynamics_comparison = 0U;
}
...
static void ext_mode_exec_c2_data_dynamics_comparison
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance)
{
  c2_update_debugger_state_c2_data_dynamics_comparison(chartInstance);
}
  ...
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = *c2_is_active_c2_data_dynamics_comparison;
   ...
   *c2_st)
{
  ...
  *c2_is_active_c2_data_dynamics_comparison = c2_g_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_data_dynamics_comparison");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_data_dynamics_comparison(chartInstance);
  ...
  (SFc2_data_dynamics_comparisonInstanceStruct *chartInstance)
{
  ...
  *c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_data_dynamics_comparison(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_data_dynamics_comparisonInstanceStruct *chartInstance;
  chartInstance = (SFc2_data_dynamics_comparisonInstanceStruct *)
    chartInstanceVoid;
...
const mxArray *sf_c2_data_dynamics_comparison_get_eml_resolved_functions_info
  (void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_is_active_c2_data_dynamics_comparison), &c2_thisId);
  sf_mex_destroy(&c2_is_active_c2_data_dynamics_comparison);
  return c2_y;
}
...
void sf_c2_data_dynamics_comparison_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_data_dynamics_comparison_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_data_dynamics_comparison(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"xdot\",},{M[8],M[0],T\"is_active_c2_data_dynamics_comparison\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_data_dynamics_comparison_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_data_dynamics_comparison(void
  *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc2_data_dynamics_comparisonInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc2_data_dynamics_comparisonInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_data_dynamics_comparison
    ((SFc2_data_dynamics_comparisonInstanceStruct*) chartInstanceVar);
  initialize_c2_data_dynamics_comparison
    ((SFc2_data_dynamics_comparisonInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_data_dynamics_comparison(void *chartInstanceVar)
{
  enable_c2_data_dynamics_comparison
    ((SFc2_data_dynamics_comparisonInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_data_dynamics_comparison(void *chartInstanceVar)
{
  disable_c2_data_dynamics_comparison
    ((SFc2_data_dynamics_comparisonInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_data_dynamics_comparison(void *chartInstanceVar)
{
  sf_c2_data_dynamics_comparison((SFc2_data_dynamics_comparisonInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c2_data_dynamics_comparison(void
  *chartInstanceVar)
{
  ext_mode_exec_c2_data_dynamics_comparison
    ((SFc2_data_dynamics_comparisonInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_data_dynamics_comparison
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_data_dynamics_comparison
    ((SFc2_data_dynamics_comparisonInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_data_dynamics_comparison();/* state var info */
...
extern void sf_internal_set_sim_state_c2_data_dynamics_comparison(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_data_dynamics_comparison
    ((SFc2_data_dynamics_comparisonInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_data_dynamics_comparison
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c2_data_dynamics_comparison(S);
}

static void sf_opaque_set_sim_state_c2_data_dynamics_comparison(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c2_data_dynamics_comparison(S, st);
}

static void sf_opaque_terminate_c2_data_dynamics_comparison(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_data_dynamics_comparisonInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_data_dynamics_comparison
      ((SFc2_data_dynamics_comparisonInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc2_data_dynamics_comparison
    ((SFc2_data_dynamics_comparisonInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_data_dynamics_comparison(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_data_dynamics_comparison
      ((SFc2_data_dynamics_comparisonInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c2_data_dynamics_comparison_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c2_data_dynamics_comparison\",T\"is_active_c2_data_dynamics_comparison\"}}"
  };
...
static void mdlSetWorkWidths_c2_data_dynamics_comparison(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_data_dynamics_comparison_optimization_info();
...
static void mdlRTW_c2_data_dynamics_comparison(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_data_dynamics_comparison(SimStruct *S)
{
  SFc2_data_dynamics_comparisonInstanceStruct *chartInstance;
  chartInstance = (SFc2_data_dynamics_comparisonInstanceStruct *)malloc(sizeof
    (SFc2_data_dynamics_comparisonInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_data_dynamics_comparisonInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_data_dynamics_comparison;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_data_dynamics_comparison;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_data_dynamics_comparison;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_data_dynamics_comparison;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_data_dynamics_comparison;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_data_dynamics_comparison;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_data_dynamics_comparison;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_data_dynamics_comparison;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_data_dynamics_comparison;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_data_dynamics_comparison;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_data_dynamics_comparison;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c2_data_dynamics_comparison;
...
void c2_data_dynamics_comparison_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_data_dynamics_comparison(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_data_dynamics_comparison(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_data_dynamics_comparison(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_data_dynamics_comparison_method_dispatcher.\n"
