...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_robot_dynamics_model_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_robot_dynamics_model_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_robot_dynamics_model_process_testpoint_info_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_robot_dynamics_model_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_robot_dynamics_model_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "robot_dynamics_model") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_robot_dynamics_model_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int sf_robot_dynamics_model_get_eml_resolved_functions_info
  ...
  if (strcmp(machineName, "robot_dynamics_model") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_robot_dynamics_model_get_eml_resolved_functions_info(nlhs,plhs,2,
      newRhs);
  }
...
extern unsigned int sf_robot_dynamics_model_method_dispatcher(SimStruct *S,
  ...
  method, void *data)
{
  if (!strcmp(machineName,"robot_dynamics_model")) {
    return(sf_robot_dynamics_model_method_dispatcher(simstructPtr,
...
extern void robot_dynamics_model_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    robot_dynamics_model_terminator();
    sf_debug_terminate();
  }
...
extern void robot_dynamics_model_initializer(void);
extern void robot_dynamics_model_register_exported_symbols(SimStruct* S);
extern void robot_dynamics_model_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  robot_dynamics_model_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      robot_dynamics_model_debug_initialize();
    }

    robot_dynamics_model_initializer();
  }
