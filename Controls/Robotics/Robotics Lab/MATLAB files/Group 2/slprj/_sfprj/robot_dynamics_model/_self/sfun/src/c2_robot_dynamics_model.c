...
static void initialize_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void initialize_params_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void enable_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void disable_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void ext_mode_exec_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void set_sim_state_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void sf_c2_robot_dynamics_model(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance);
static void c2_chartstep_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void initSimStructsc2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance, const mxArray *c2_xdot, const char_T *c2_identifier, real_T
  c2_y[4]);
static void c2_b_emlrt_marshallIn(SFc2_robot_dynamics_modelInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_d_emlrt_marshallIn(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[2]);
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[4]);
static void c2_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[33]);
static real_T c2_mpower(SFc2_robot_dynamics_modelInstanceStruct *chartInstance,
  real_T c2_a);
static void c2_eml_scalar_eg(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance);
static void c2_eml_warning(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_f_emlrt_marshallIn(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_g_emlrt_marshallIn(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance, const mxArray *c2_is_active_c2_robot_dynamics_model, const
  char_T *c2_identifier);
static uint8_T c2_h_emlrt_marshallIn(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_robot_dynamics_modelInstanceStruct
  *chartInstance);
...
{
  int32_T *c2_sfEvent;
  uint8_T *c2_is_active_c2_robot_dynamics_model;
  c2_is_active_c2_robot_dynamics_model = (uint8_T *)ssGetDWork(chartInstance->S,
    3);
  c2_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  *c2_sfEvent = CALL_EVENT;
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  *c2_is_active_c2_robot_dynamics_model = 0U;
}
...
static void ext_mode_exec_c2_robot_dynamics_model
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance)
{
  c2_update_debugger_state_c2_robot_dynamics_model(chartInstance);
}
  ...
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = *c2_is_active_c2_robot_dynamics_model;
  ...
  (SFc2_robot_dynamics_modelInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  *c2_is_active_c2_robot_dynamics_model = c2_g_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 1)), "is_active_c2_robot_dynamics_model");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_robot_dynamics_model(chartInstance);
  ...
  *chartInstance)
{
  ...
  *c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_robot_dynamics_model(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_robot_dynamics_modelInstanceStruct *chartInstance;
  chartInstance = (SFc2_robot_dynamics_modelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_robot_dynamics_model_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_is_active_c2_robot_dynamics_model), &c2_thisId);
  sf_mex_destroy(&c2_is_active_c2_robot_dynamics_model);
  return c2_y;
}
...
void sf_c2_robot_dynamics_model_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_robot_dynamics_model_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_robot_dynamics_model(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"xdot\",},{M[8],M[0],T\"is_active_c2_robot_dynamics_model\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_robot_dynamics_model_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_robot_dynamics_modelInstanceStruct *chartInstance;
    chartInstance = (SFc2_robot_dynamics_modelInstanceStruct *)
...
static void sf_opaque_initialize_c2_robot_dynamics_model(void *chartInstanceVar)
{
  sf_check_dwork_consistency(((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInstanceVar)->S);
  chart_debug_initialization(((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_robot_dynamics_model
    ((SFc2_robot_dynamics_modelInstanceStruct*) chartInstanceVar);
  initialize_c2_robot_dynamics_model((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_robot_dynamics_model(void *chartInstanceVar)
{
  enable_c2_robot_dynamics_model((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_robot_dynamics_model(void *chartInstanceVar)
{
  disable_c2_robot_dynamics_model((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_robot_dynamics_model(void *chartInstanceVar)
{
  sf_c2_robot_dynamics_model((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_ext_mode_exec_c2_robot_dynamics_model(void
  *chartInstanceVar)
{
  ext_mode_exec_c2_robot_dynamics_model((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_robot_dynamics_model
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_robot_dynamics_model
    ((SFc2_robot_dynamics_modelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_robot_dynamics_model();/* state var info */
...
extern void sf_internal_set_sim_state_c2_robot_dynamics_model(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_robot_dynamics_model((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_robot_dynamics_model(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c2_robot_dynamics_model(S);
}

static void sf_opaque_set_sim_state_c2_robot_dynamics_model(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_robot_dynamics_model(S, st);
}

static void sf_opaque_terminate_c2_robot_dynamics_model(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_robot_dynamics_modelInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_robot_dynamics_model((SFc2_robot_dynamics_modelInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_robot_dynamics_model((SFc2_robot_dynamics_modelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_robot_dynamics_model(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c2_robot_dynamics_model
      ((SFc2_robot_dynamics_modelInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

mxArray *sf_c2_robot_dynamics_model_get_testpoint_info(void)
{
  const char *infoEncStr[] = {
    "100 S'varName','path'{{T\"is_active_c2_robot_dynamics_model\",T\"is_active_c2_robot_dynamics_model\"}}"
  };
...
static void mdlSetWorkWidths_c2_robot_dynamics_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_robot_dynamics_model_optimization_info();
...
static void mdlRTW_c2_robot_dynamics_model(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_robot_dynamics_model(SimStruct *S)
{
  SFc2_robot_dynamics_modelInstanceStruct *chartInstance;
  chartInstance = (SFc2_robot_dynamics_modelInstanceStruct *)malloc(sizeof
    (SFc2_robot_dynamics_modelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_robot_dynamics_modelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_robot_dynamics_model;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_robot_dynamics_model;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_robot_dynamics_model;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_robot_dynamics_model;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_robot_dynamics_model;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_robot_dynamics_model;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_robot_dynamics_model;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_robot_dynamics_model;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_robot_dynamics_model;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_robot_dynamics_model;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_robot_dynamics_model;
  chartInstance->chartInfo.extModeExec =
    sf_opaque_ext_mode_exec_c2_robot_dynamics_model;
...
void c2_robot_dynamics_model_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_robot_dynamics_model(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_robot_dynamics_model(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_robot_dynamics_model(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_robot_dynamics_model_method_dispatcher.\n"
