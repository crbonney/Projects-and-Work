...
typedef RT_MODEL_Jan23Lab2model RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Jan23Lab2model(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Jan23Lab2model_initialize();
   extern void Jan23Lab2model_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Jan23Lab2model_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://Jan23Lab2model:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Jan23Lab2model -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
