...
typedef RT_MODEL_Jan14IntroExercise RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Jan14IntroExercise(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Jan14IntroExercise_initialize();
   extern void Jan14IntroExercise_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Jan14IntroExercise_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Jan14IntroExercise -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  Jan14IntroExercise_initialize();
  S = Jan14IntroExercise_M;
