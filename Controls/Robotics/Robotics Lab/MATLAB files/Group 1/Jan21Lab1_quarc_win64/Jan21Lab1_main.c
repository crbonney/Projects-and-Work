...
typedef RT_MODEL_Jan21Lab1 RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Jan21Lab1(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void Jan21Lab1_initialize();
   extern void Jan21Lab1_terminate();
 */

/* extern void Jan21Lab1_step(void); */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Jan21Lab1_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://Jan21Lab1:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Jan21Lab1 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
