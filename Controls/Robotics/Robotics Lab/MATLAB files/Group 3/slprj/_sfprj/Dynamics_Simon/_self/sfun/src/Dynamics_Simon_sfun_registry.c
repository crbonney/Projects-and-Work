...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_Dynamics_Simon_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Dynamics_Simon_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_Dynamics_Simon_process_testpoint_info_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_Dynamics_Simon_process_testpoint_info_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Dynamics_Simon_autoinheritance_info( int nlhs, mxArray *
  ...
  if (strcmp(machineName, "Dynamics_Simon") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_Dynamics_Simon_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
unsigned int sf_process_get_eml_resolved_functions_info_call( int nlhs, mxArray *
  plhs[], int nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_Dynamics_Simon_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "Dynamics_Simon") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_Dynamics_Simon_get_eml_resolved_functions_info(nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_Dynamics_Simon_method_dispatcher(SimStruct *S, unsigned
  ...
  method, void *data)
{
  if (!strcmp(machineName,"Dynamics_Simon")) {
    return(sf_Dynamics_Simon_method_dispatcher(simstructPtr,chartFileNumber,
...
extern void Dynamics_Simon_terminator(void);
...
extern void Dynamics_Simon_initializer(void);
extern void Dynamics_Simon_register_exported_symbols(SimStruct* S);
extern void Dynamics_Simon_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  Dynamics_Simon_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      Dynamics_Simon_debug_initialize();
    }

    Dynamics_Simon_initializer();
  }
