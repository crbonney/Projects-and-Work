...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_hamiltonian_data_collector_process_check_sum_call( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_hamiltonian_data_collector_process_check_sum_call(nlhs,plhs,nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_hamiltonian_data_collector_process_testpoint_info_call(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_hamiltonian_data_collector_process_testpoint_info_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
unsigned int sf_process_autoinheritance_call( int nlhs, mxArray * plhs[], int
  nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_hamiltonian_data_collector_autoinheritance_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "hamiltonian_data_collector") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_hamiltonian_data_collector_autoinheritance_info(nlhs,plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_hamiltonian_data_collector_get_eml_resolved_functions_info( int nlhs,
  ...
  if (strcmp(machineName, "hamiltonian_data_collector") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_hamiltonian_data_collector_get_eml_resolved_functions_info(nlhs,
      plhs,2,newRhs);
  }
...
extern unsigned int sf_hamiltonian_data_collector_method_dispatcher(SimStruct *S,
  ...
  method, void *data)
{
  if (!strcmp(machineName,"hamiltonian_data_collector")) {
    return(sf_hamiltonian_data_collector_method_dispatcher(simstructPtr,
...
extern void hamiltonian_data_collector_terminator(void);
void sf_machine_global_terminator(void)
{
  if (sfMachineGlobalTerminatorCallable) {
    ...
    hamiltonian_data_collector_terminator();
    sf_debug_terminate();
  }
...
extern void hamiltonian_data_collector_initializer(void);
extern void hamiltonian_data_collector_register_exported_symbols(SimStruct* S);
extern void hamiltonian_data_collector_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  hamiltonian_data_collector_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfMachineGlobalInitializerCallable) {
    ...
    if (!simModeIsRTWGen) {
      hamiltonian_data_collector_debug_initialize();
    }

    hamiltonian_data_collector_initializer();
  }
