...
static const char * c2_debug_family_names[21] = { "g", "theta1", "theta2",
  "theta3", "theta4", "theta5", "theta6", "q1", "q2", "q1dot", "q2dot", "v", "m",
  "c", "f", "acceleration", "nargin", "nargout", "x", "u", "xdot" };
  ...
  (SFc2_hamiltonian_data_collectorInstanceStruct *chartInstance)
{
  ...
  c2_hb_x = (real_T (*)[4])ssGetInputPortSignal(chartInstance->S, 0);
  c2_sfEvent = (int32_T *)ssGetDWork(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 1U, *c2_sfEvent);
  c2_hoistedGlobal = *c2_b_u;
  for (c2_i4 = 0; c2_i4 < 4; c2_i4++) {
    c2_x[c2_i4] = (*c2_hb_x)[c2_i4];
  }

  c2_u = c2_hoistedGlobal;
  sf_debug_symbol_scope_push_eml(0U, 21U, 22U, c2_debug_family_names,
    c2_debug_family_var_map);
  sf_debug_symbol_scope_add_eml(&c2_g, MAX_uint32_T, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_theta1, 1U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c2_theta2, 2U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_theta3, 3U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_theta4, 4U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_theta5, 5U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_theta6, 6U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(&c2_q1, 7U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_q2, 8U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_q1dot, 9U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c2_q2dot, 10U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_v, 11U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_m, 12U, c2_d_sf_marshallOut,
    c2_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_c, 13U, c2_d_sf_marshallOut,
    c2_d_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_f, 14U, c2_c_sf_marshallOut,
    c2_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c2_acceleration, 15U,
  ...
  sf_debug_symbol_scope_add_eml_importable(&c2_nargout, 17U, c2_b_sf_marshallOut,
    c2_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c2_x, 18U, c2_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c2_u, 19U, c2_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c2_xdot, 20U, c2_sf_marshallOut,
    c2_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c2_theta1 = 0.089626860251478;
  _SFD_EML_CALL(0U, *c2_sfEvent, 34);
  c2_theta2 = 0.027476488534314;
  _SFD_EML_CALL(0U, *c2_sfEvent, 35);
  c2_theta3 = 0.029103291131862;
  _SFD_EML_CALL(0U, *c2_sfEvent, 36);
  c2_theta4 = 0.114763241730839;
  _SFD_EML_CALL(0U, *c2_sfEvent, 37);
  c2_theta5 = 0.560169997835625;
  _SFD_EML_CALL(0U, *c2_sfEvent, 38);
  c2_theta6 = 0.011135861988403;
  ...
  c2_y = 0.027476488534314 * c2_b;
  c2_d_x = c2_q2;
  c2_e_x = c2_d_x;
  c2_e_x = muDoubleScalarCos(c2_e_x);
  c2_b_b = c2_e_x;
  c2_b_y = 0.029103291131862 * c2_b_b;
  c2_f_x = c2_q2;
  c2_g_x = c2_f_x;
  c2_g_x = muDoubleScalarCos(c2_g_x);
  c2_c_b = c2_g_x;
  c2_c_y = 0.029103291131862 * c2_c_b;
  ...
  c2_d_b = c2_i_x;
  c2_d_y = 0.054952977068628 * c2_d_b;
  c2_j_x = c2_q2;
  c2_k_x = c2_j_x;
  ...
  c2_g_b = c2_m_x;
  c2_g_y = -0.029103291131862 * c2_g_b;
  c2_c_a = c2_g_y;
  c2_h_b = c2_q2dot;
  c2_h_y = c2_c_a * c2_h_b;
  c2_n_x = c2_q2;
  c2_o_x = c2_n_x;
  c2_o_x = muDoubleScalarSin(c2_o_x);
  c2_i_b = c2_o_x;
  c2_i_y = -0.027476488534314 * c2_i_b;
  c2_p_x = c2_q2;
  c2_q_x = c2_p_x;
  ...
  c2_l_b = c2_q1dot;
  c2_l_y = 0.560169997835625 * c2_l_b;
  c2_m_b = c2_q2dot;
  c2_m_y = 0.011135861988403 * c2_m_b;
  c2_f[0] = c2_l_y;
  c2_f[1] = c2_m_y;
  _SFD_EML_CALL(0U, *c2_sfEvent, 65);
  c2_r_x = c2_q2;
  c2_s_x = c2_r_x;
  c2_s_x = muDoubleScalarSin(c2_s_x);
  c2_n_b = c2_s_x;
  c2_n_y = -1.1258274013795306 * c2_n_b;
  c2_b_g[0] = 0.0;
  c2_b_g[1] = c2_n_y;
  sf_debug_symbol_switch(0U, 16U);
  _SFD_EML_CALL(0U, *c2_sfEvent, 71);
  for (c2_i5 = 0; c2_i5 < 4; c2_i5++) {
    c2_f_a[c2_i5] = c2_c[c2_i5];
  }
  ...
  for (c2_i6 = 0; c2_i6 < 2; c2_i6++) {
    ...
    for (c2_i8 = 0; c2_i8 < 2; c2_i8++) {
      c2_o_y[c2_i6] += c2_f_a[c2_i7 + c2_i6] * c2_o_b[c2_i8];
      c2_i7 += 2;
    }
  }

  for (c2_i9 = 0; c2_i9 < 4; c2_i9++) {
    c2_f_a[c2_i9] = -c2_m[c2_i9];
  }

  for (c2_i10 = 0; c2_i10 < 2; c2_i10++) {
    c2_o_y[c2_i10] = ((c2_o_y[c2_i10] + c2_f[c2_i10]) + c2_b_g[c2_i10]) -
      c2_v[c2_i10];
  }
  ...
  c2_w_x = 0.0;
  c2_x_x = c2_w_x;
  c2_q_y = muDoubleScalarAbs(c2_x_x);
  c2_d = c2_p_y + c2_q_y;
  c2_y_x = c2_f_a[0];
  c2_ab_x = c2_y_x;
  c2_bb_x = c2_ab_x;
  ...
  c2_cb_x = 0.0;
  c2_db_x = c2_cb_x;
  c2_s_y = muDoubleScalarAbs(c2_db_x);
  ...
  c2_eb_x = c2_f_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c2_r2), 1, 2, 1, 0) - 1];
  c2_t_y = c2_f_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 2, 1, 0) - 1];
  c2_a21 = c2_eb_x / c2_t_y;
  c2_g_a = c2_a21;
  ...
  c2_eml_scalar_eg(chartInstance);
  c2_h_a = c2_o_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 2, 1, 0) - 1];
  c2_q_b = c2_a21;
  c2_v_y = c2_h_a * c2_q_b;
  c2_fb_x = c2_o_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c2_r2), 1, 2, 1, 0) - 1] - c2_v_y;
  c2_w_y = c2_a22;
  c2_z = c2_fb_x / c2_w_y;
  c2_acceleration[1] = c2_z;
  c2_i_a = c2_acceleration[1];
  c2_r_b = c2_f_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 2, 1, 0) + 1];
  c2_x_y = c2_i_a * c2_r_b;
  c2_gb_x = c2_o_y[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
    "", (real_T)c2_r1), 1, 2, 1, 0) - 1] - c2_x_y;
  c2_y_y = c2_f_a[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK("",
    (real_T)c2_r1), 1, 2, 1, 0) - 1];
  c2_b_z = c2_gb_x / c2_y_y;
  c2_acceleration[0] = c2_b_z;
  _SFD_EML_CALL(0U, *c2_sfEvent, 74);
  c2_xdot[0] = c2_q1dot;
  c2_xdot[1] = c2_q2dot;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2125601050U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(266963315U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3207177593U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(522327831U);
}
...
mxArray *sf_c2_hamiltonian_data_collector_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("WKGVZgwQlZZ7lKxFUzXUiE");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1508);
...
static void mdlSetWorkWidths_c2_hamiltonian_data_collector(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4146054833U));
  ssSetChecksum1(S,(3410245041U));
  ssSetChecksum2(S,(794857305U));
  ssSetChecksum3(S,(374149843U));
