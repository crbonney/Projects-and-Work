...
typedef RT_MODEL_physical_dynamics_tran RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * physical_dynamics_transfer_model(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void physical_dynamics_transfer_model_initialize();
   extern void physical_dynamics_transfer_model_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(physical_dynamics_transfer_m_M, GBLbuf.message);
}
...
static void rt_OneStep(RT_MODEL *S)
{
  ...
  physical_dynamics_transfer_model_step();
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv,
    "shmem://physical_dynamics_transfer_model:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: physical_dynamics_transfer_model -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  physical_dynamics_transfer_model_initialize();
  S = physical_dynamics_transfer_model_M;
  ...
  physical_dynamics_transfer_model_terminate();
